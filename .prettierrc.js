module.exports = {
    arrowParens: 'always', // adds parenthesis around single-parameter arrow functions.
    ...
    tabWidth: 4,
    trailingComma: 'es5', // trailing commas in objects, arrays. not for type parameters.
